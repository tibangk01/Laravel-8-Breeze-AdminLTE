                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="p-2">
                                ...
                                <a class="btn btn-info btn-flat text-dark" href="{{ route('logout') }}" onclick="event.preventDefault();this.closest('form').submit();">
                                    <i class="fa fa-arrow-circle-right"></i> {{ __('Log Out') }}
                                </a>
